(() => {
  if (typeof window === "undefined" || window.__yangoCloudSaveStatusV5) return;
  window.__yangoCloudSaveStatusV5 = true;
  ...
  if (originalFetch && !window.__yangoCloudSaveFetchMonitorV5) {
    window.__yangoCloudSaveFetchMonitorV5 = true;
